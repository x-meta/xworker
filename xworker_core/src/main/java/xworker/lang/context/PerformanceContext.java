...
public class PerformanceContext {
	private static Logger log = LoggerFactory.getLogger(PerformanceContext.class);	
	...
	public static void init(ActionContext actionContext){
		...
		bindings.put(context.getMetadata().getPath(), new Long(System.currentTimeMillis()));
	}
	...
	public static void success(ActionContext actionContext){
		...
		if(log.isInfoEnabled()){
			...
			long start = ((Long) bindings.get(context.getMetadata().getPath())).longValue();
