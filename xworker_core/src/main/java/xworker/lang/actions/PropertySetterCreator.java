...
public class PropertySetterCreator {
	private static Logger logger = LoggerFactory.getLogger(PropertySetterCreator.class);
    ...
    public static void run(ActionContext actionContext) throws OgnlException{
        ...
        if(dataSource != null &&!"".equals(dataSource)){
            ...
            if(data != null){
            	...
            	logger.info("propertyName: " + propertyName + " , value=" + value);
            	OgnlUtil.setValue(propertyName, data, value);
            }else{
            	logger.info("dataSource is null, dataSource=" + dataSource + ", thing=" + self);
            }            
        }else{
