...
public class ObjectPropertiesSetterCreator {
	private static Logger log = LoggerFactory.getLogger(ObjectPropertiesSetterCreator.class);
        ...
        if(properties != null){
            for(Thing property : properties.getChilds()){
                try{
                    ...
                    log.warn("set property error, property=" + property.getMetadata().getPath());
                    throw e;
                }
            }
        }
