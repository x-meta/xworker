...
public class XMetaLibsEntry implements CompressEntry{
	List<CompressEntry> childs = new ArrayList<CompressEntry>();
	boolean decompress;
	
	public XMetaLibsEntry(String rootPath, boolean decompress, boolean store){
	...
	public static XMetaLibsEntry create(ActionContext actionContext){
		...
		return new XMetaLibsEntry(path, decompress, store);
	}
