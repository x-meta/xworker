...
public class BorderLayoutCreator {
	public static BorderLayout create(ActionContext actionContext){
		//变量
	...
	public static void init(BorderLayout comp, Thing thing, Container parent, ActionContext actionContext){
