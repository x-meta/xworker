...
public class GridBagLayoutCreator {
	public static GridBagLayout create(ActionContext actionContext){
		//变量
	...
	public static void init(GridBagLayout comp, Thing thing, Container parent, ActionContext actionContext){
	}
}