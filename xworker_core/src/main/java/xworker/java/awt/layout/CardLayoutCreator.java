...
public class CardLayoutCreator {
	public static CardLayout create(ActionContext actionContext){
		//变量
		Thing self = (Thing) actionContext.get("self");
		Container parent = (Container) actionContext.get("parent");
		
		//创建
		CardLayout comp = new CardLayout();
		if(parent != null){
	...
	public static void init(CardLayout comp, Thing thing, Container parent, ActionContext actionContext){
