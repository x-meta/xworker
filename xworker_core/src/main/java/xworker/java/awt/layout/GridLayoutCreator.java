...
public class GridLayoutCreator {
	public static GridLayout create(ActionContext actionContext){
		//变量
	...
	public static void init(GridLayout comp, Thing thing, Container parent, ActionContext actionContext){
		...
		Integer cols = JavaCreator.createInteger(thing, "cols");
		if(cols != null){
