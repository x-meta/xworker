...
public class BevelBorderCreator {
	public static Object create(ActionContext actionContext){
		...
		if(highlight != null || shadow != null){
			border = new BevelBorder(type, highlight, shadow);
		}else{
			...
			border = new BevelBorder(type, highlightOuterColor, highlightInnerColor, shadowOuterColor, shadowInnerColor);
		}
