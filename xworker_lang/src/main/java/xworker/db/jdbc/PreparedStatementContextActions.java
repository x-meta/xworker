...
public class PreparedStatementContextActions {
	private static final String TAG = PreparedStatementContextActions.class.getName();
	...
	public static void init(ActionContext actionContext) throws SQLException{
		...
		if(con == null){
		    Executor.info(TAG, "PreparedStatementContext: connection is null, name=" + self.getString("connection"));
		    return;
		}
