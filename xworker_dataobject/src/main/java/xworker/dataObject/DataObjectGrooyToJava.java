...
public class DataObjectGrooyToJava {
	static String[] excludes = new String[]{
		"xworker.dataObject.datastax.CassandraDataObject",
		...
		"xworker.dataObject.swt.AttributeDataObjectSelector",
		...
		"xworker.dataObject.xworker.XWorkerDataObject"
	};
