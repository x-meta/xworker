...
public class TreeModelActionsInsertCreator {
	//private static Logger log = LoggerFactory.getLogger(TreeModelActionsInsertCreator.class);
	private static final String TAG = TreeModelActionsInsertCreator.class.getName();
