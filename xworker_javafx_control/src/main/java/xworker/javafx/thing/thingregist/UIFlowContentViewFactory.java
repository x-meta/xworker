...
public class UIFlowContentViewFactory implements ContentViewFactory{
    @Override
    public Node createContentNode(Content<?> content, final ActionContext actionContext) {
        ...
        button.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                shell.addChild(World.getInstance().getThing("xworker.swt.xworker.ThingRegistThing/@composite/@UiFlow"), false);
