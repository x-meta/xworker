...
:RESTART
start "" "%JAVA%" %JAVA_OPTS% "-Djava.endorsed.dirs=%XWORKER_ENDORSED_DIRS%" -classpath "%XWORKER_CLASSPATH%;%XWORKER_HOME%xworker.jar" xworker.startup.Startup  %XWORKER_HOME% %*
