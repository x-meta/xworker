...
function collapseAll() {
    window.location.replace("do?sc=core:help:html.TocView:/@tocView");
    return true;
}

function setShowAll(isShowAll, href) {
    var showAllParam = isShowAll ? "on" : "off";
    window.location.replace("do?sc=core:help:html.TocView:/@tocView&showAll=" + showAllParam);
}
...
function makeNodeRequest(parameters) {
    var href = "do?sc=core:help:html.Tocfragment:/@tocfragment" + parameters;
