...
Ext.ux.DateTimeRenderer = function(v) {
	if (!Ext.isDate(v)) {
		return v;
	} else {
		return v.format(Ext.ux.DateTimeFormat);
	}
};

Ext.ux.DateFormat = 'm/d/Y';
Ext.ux.TimeFormat = 'h:i:s A';
Ext.ux.ShortTimeFormat = 'h:i A';
Ext.ux.DateTimeFormat = Ext.ux.DateFormat + ' ' + Ext.ux.TimeFormat;
Ext.ux.ShortDateTimeFormat = Ext.ux.DateFormat + ' ' + Ext.ux.ShortTimeFormat;