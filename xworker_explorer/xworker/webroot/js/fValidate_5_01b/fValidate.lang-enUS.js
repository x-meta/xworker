...
fvalidate.i18n =
{
	...
	devErrors:
	{
		...
		paramError: ["You must include the '", 0, "' parameter for the '", 1, "' validator type on this attribute: ", 2],
	...
	boxToolTip:	"Click to target attribute",
