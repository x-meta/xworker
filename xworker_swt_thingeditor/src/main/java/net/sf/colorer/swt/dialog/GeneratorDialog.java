...
public class GeneratorDialog {
  ...
  /**
   * @param list The fileList to set - Vector with list of file paths
   */
  ...
  /**
   * @param val The htmlHeaderFooter to set.
   */
  ...
  /**
   * @param val The htmlSubst to set.
   */
  ...
  /**
   * @param val The infoHeader to set.
   */
  ...
  /**
   * @param progress The progressBar to set.
   */
  ...
  /**
   * @param val The targetDirectory to set.
   */
  ...
  /**
   * @param val The useLineNumbers to set.
   */
