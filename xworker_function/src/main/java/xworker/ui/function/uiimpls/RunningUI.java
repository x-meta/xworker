 ...
 *
 */
public class RunningUI extends FunctionRequestUI{
	private static Logger log = LoggerFactory.getLogger(RunningUI.class);
		...
		Runnable runnable = new Runnable(){
			public void run(){
				...
				if(citem != tabItem){
					...
					actions.doAction("initFunctionRequest", actionContext, UtilMap.toMap(new Object[]{"functionRequestUI", ui}));
				}
			}
		};
