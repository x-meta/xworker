<html>
<head>
<title>${server.metadata.label?if_exists}</title>
...
<table width="600"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td nowrap class="label-title" align="center">${server.metadata.label?if_exists}</td>
  </tr>
</table>
...
<table width="600"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr width="50%">
    <td nowrap width="300" rowspan="2"><img src="${server.logo?if_exists}" width="300" height="216"></td>
  </tr>
  <tr width="50%">
  <td nowrap>
<form name="nwLoginForm" method="POST" action="do?sc=${server.metadata.path}">
    <input type="hidden" name="ac" value="checkLogin"/>    
    <input type="hidden" name="oldUrl" value="${requestBean.oldUrl?if_exists}"/>
...
<table cellpadding='0' cellspacing='0' width='100%' border='0'>
	<tr>
		<td nowrap height="50" align='center' class='input-3'>&copy; ${server.company?if_exists}
		</td>
	</tr>
</table>
</body>
