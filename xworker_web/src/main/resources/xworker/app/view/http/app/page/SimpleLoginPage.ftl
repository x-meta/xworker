...
<table width="600"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td nowrap class="label-title" align="center">${data.title?if_exists}</td>
  </tr>
</table>
...
<table width="600"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr width="50%">
    <td nowrap width="300" rowspan="2"><img src="${data.logo?if_exists}" width="300" height="216"></td>
  </tr>
  <tr width="50%">
  <td nowrap>
...
<table cellpadding='0' cellspacing='0' width='100%' border='0'>
	<tr>
		<td nowrap height="50" align='center' class='input-3'>&copy; ${data.company?if_exists}
		</td>
	</tr>
</table>
</body>
