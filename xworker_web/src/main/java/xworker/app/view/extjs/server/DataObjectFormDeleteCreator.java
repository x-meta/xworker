	...
	public static void doAction(ActionContext actionContext) throws IOException{
        ...
        if(dataObjectConfig == null){
            ...
            try{
                ...
                theData.doAction("delete", actionContext);
                
                if(result.get("success").equals(true) || result.get("success").equals(new Boolean(true))){
                    theData = (DataObject) dataObjectConfig.doAction("newInstance", actionContext);
                }
