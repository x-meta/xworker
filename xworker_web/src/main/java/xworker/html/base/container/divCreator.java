...
public class divCreator {
    public static Object toHtml(ActionContext actionContext) throws Throwable{
        ...
        return UtilTemplate.process(UtilMap.toMap(new Object[]{"object",self, "childHtmls",childHtmls}), "/xworker/html/base/templates/div.ftl", "freemarker", "utf-8");
    }
