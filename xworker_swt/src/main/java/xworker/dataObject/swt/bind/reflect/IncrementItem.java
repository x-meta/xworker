...
public class IncrementItem extends ReflectItem {

	public IncrementItem(Thing thing,  Widget widget, ActionContext actionContext) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		super(thing, widget, actionContext, "getIncrement", "setIncrement", int.class);
	}
	...
	public static void create(ActionContext actionContext) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		...
		if(widgets != null) {
			for(String name : widgets.split("[,]")) {
				...
				if(widget != null) {
					BinderItem item = new IncrementItem(self, widget, actionContext);
