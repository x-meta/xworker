...
public class AlignmentItem extends ReflectItem {

	public AlignmentItem(Thing thing, Widget widget, ActionContext actionContext) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		super(thing, widget, actionContext, "getAlignment", "setAlignment", int.class);
	}
	...
	public static void create(ActionContext actionContext) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		...
		if(widgets != null) {
			for(String name : widgets.split("[,]")) {
				...
				if(widget != null) {
					BinderItem item = new AlignmentItem(self, widget, actionContext);
