...
public class MinimumItem extends ReflectItem {

	public MinimumItem(Thing thing,  Widget widget, ActionContext actionContext) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		super(thing, widget, actionContext, "getMinimum", "setMinimum", boolean.class);
	}
	...
	public static void create(ActionContext actionContext) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		...
		if(widgets != null) {
			for(String name : widgets.split("[,]")) {
				...
				if(widget != null) {
					BinderItem item = new MinimumItem(self, widget, actionContext);
