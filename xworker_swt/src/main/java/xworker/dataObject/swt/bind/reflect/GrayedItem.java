...
public class GrayedItem extends ReflectItem {

	public GrayedItem(Thing thing,  Widget widget, ActionContext actionContext) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		super(thing, widget, actionContext, "getGrayed", "setGrayed", boolean.class);
	}
	...
	public static void create(ActionContext actionContext) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		...
		if(widgets != null) {
			for(String name : widgets.split("[,]")) {
				...
				if(widget != null) {
					BinderItem item = new GrayedItem(self, widget, actionContext);
