...
public class MaximumItem extends ReflectItem {

	public MaximumItem(Thing thing, Widget widget,  ActionContext actionContext) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		super(thing, widget, actionContext, "getMaximum", "setMaximum", int.class);
	}
	...
	public static void create(ActionContext actionContext) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		...
		if(widgets != null) {
			for(String name : widgets.split("[,]")) {
				...
				if(widget != null) {
					BinderItem item = new MaximumItem(self, widget, actionContext);
