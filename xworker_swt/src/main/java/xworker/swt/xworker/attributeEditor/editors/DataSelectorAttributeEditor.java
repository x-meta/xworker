...
public class DataSelectorAttributeEditor extends AttributeEditor{

	public DataSelectorAttributeEditor(Thing formThing, Thing attribute, xworker.swt.form.GridData gridData, ActionContext actionContext) {
	...
	public Control createControl(Composite parent, FormModifyListener modifyListener, Listener defaultSelection) {
        ...
        newContext.put("selectType", "thing");
