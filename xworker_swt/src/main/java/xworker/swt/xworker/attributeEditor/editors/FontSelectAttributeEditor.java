...
public class FontSelectAttributeEditor extends AttributeEditor{

	public FontSelectAttributeEditor(Thing formThing, Thing attribute, xworker.swt.form.GridData gridData, ActionContext actionContext) {
	...
	public Control createControl(Composite parent, FormModifyListener modifyListener, Listener defaultSelection) {
        ...
        selectDataButton.addSelectionListener(new FontListener(dataSelectText));
