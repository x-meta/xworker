...
public class RadioAttributeEditor extends AttributeEditor{

	public RadioAttributeEditor(Thing formThing, Thing attribute, xworker.swt.form.GridData gridData, ActionContext actionContext) {
        ...
        if(dataStore == null){ //如果数据仓库为空走原来的流程			        
	        ...
	        if(values != null){
		        for(int k=0; k<values.size(); k++){
		            ...
		            index ++;
		            Button radioButton1 = new Button(radioComposite, SWT.RADIO);
