...
public class TextareaAttributeEditor extends AttributeEditor{

	public TextareaAttributeEditor(Thing formThing, Thing attribute, xworker.swt.form.GridData gridData, ActionContext actionContext) {
	...
	public Control createControl(Composite parent, FormModifyListener modifyListener, Listener defaultSelection) {
        ...
        try{
        	...
        	Designer.attach(obj, path, context, true);
