...
public class DOCreator {
    public static Object create(ActionContext actionContext) throws OgnlException{
        ...
        String code = self.getString("while");
        do{            
        ...
        //}while(UtilAction.returnTrueFalse(UtilAction.runAsGroovy(self, "code", actionContext, self.getMetadata().getPath())));
        }while((Boolean) OgnlUtil.getValue(code, actionContext));
