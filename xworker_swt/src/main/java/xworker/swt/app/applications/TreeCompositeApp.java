...
public class TreeCompositeApp {
	public static Composite create(ActionContext actionContext) {
		...
		//模板
		Thing prototype = world.getThing("xworker.swt.app.applications.prototypes.TreeCompositeAppPrototype/@mainComposite");
		...
		//创建主菜单
		Widget expandBar = actionContext.getObject("tree");
