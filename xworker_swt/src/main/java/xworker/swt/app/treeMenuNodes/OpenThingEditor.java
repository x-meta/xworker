...
public class OpenThingEditor {
	private static final String TAG = OpenThingEditor.class.getName();
	...
	public static void run(ActionContext actionContext) {
		...
		Thing editor = world.getThing("xworker.swt.app.editors.ThingEditor");
