...
public class ShellDesignTools implements IDesignTool<Shell>{
	...
	@Override
	public Control insertAboveOrBelow(Shell parent, Control control,
	...
	@Override
	public Control update(Shell parent, Control control) {
		if(!checkLayout(parent)){
			return null;
		}
	...
	@Override
	public Control insert(Shell parent, Thing thing) {
		if(!checkLayout(parent)){
			return null;
		}
	...
	@Override
	public Control replace(Shell parent, Control control, Thing thing) {
		if(!checkLayout(parent)){
			return null;
		}
