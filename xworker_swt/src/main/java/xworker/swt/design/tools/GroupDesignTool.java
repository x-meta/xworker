...
public class GroupDesignTool implements IDesignTool<Group>{
	...
	@Override
	public Control insertAboveOrBelow(Group parent, Control control,
	...
	@Override
	public Control update(Group parent, Control control) {
		if(!checkLayout(parent)){
			return null;
		}
	...
	@Override
	public Control insert(Group parent, Thing thing) {
		if(!checkLayout(parent)){
			return null;
		}
	...
	@Override
	public Control replace(Group parent, Control control, Thing thing) {
		if(!checkLayout(parent)){
			return null;
		}
