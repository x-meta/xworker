...
public class ToolTipStatusListener implements StatusTextListener, ProgressListener{
    Shell shell;
    ...
    public void changed(StatusTextEvent event) {
    	...
    	if(event.text.startsWith("html_edit_content")){
    	    ...
    	    String content = event.text.substring(event.text.indexOf(":") + 1, event.text.length());
