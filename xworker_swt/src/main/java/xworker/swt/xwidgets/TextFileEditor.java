...
public class TextFileEditor {
		...
		if(SwtUtils.isRWT() == false) {
			return self.doAction("createStyledText", actionContext);
		}
		
		
		//创建主composite
		Thing compositeThing = World.getInstance().getThing("xworker.swt.xwidgets.TextFileEditor/@mainComposite1");
	...
	public static void setFile(ActionContext actionContext) throws IOException{
		...
		Text codeEditor = (Text) actionContext.get("codeEditor");
